...
#define	PA04                           4U
#define	PA05_SPI6_INTERNAL_CLK         5U
#define	PA06_SRVB1                     6U
#define	PA07_SRVB2                     7U
#define	PA08                           8U
#define	PA09_USB_VBUS                  9U
#define	PA10_DSHOT_TLM                 10U
...
#define	PB00_SRVB3                     0U
#define	PB01_SRVB4                     1U
#define	PB02                           2U
#define	PB03_UART7_RX                  3U
#define	PB04_SPI6_INTERNAL_MISO        4U
#define	PB05_SPI6_INTERNAL_MOSI        5U
#define	PB06_AUX_B1                    6U
#define	PB07_AUX_B2                    7U
#define	PB08_AUX_B3                    8U
#define	PB09_AUX_B4                    9U
...
#define	PD11                           11U
#define	PD12_I2C4_SCL_INTERNAL         12U
#define	PD13_I2C4_SDA_INTERNAL         13U
#define	PD14                           14U
#define	PD15_LED3                      15U
...
#define	LINE_SPI2_CS_EXTERNAL          PAL_LINE(GPIOB, 12U)
...
#define	LINE_I2C4_SCL_INTERNAL         PAL_LINE(GPIOD, 12U)
#define	LINE_I2C4_SDA_INTERNAL         PAL_LINE(GPIOD, 13U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_INPUT(PA00_AUX_A1) | \
					 ...
					 PIN_MODE_INPUT(PA04) | \
					 PIN_MODE_ALTERNATE(PA05_SPI6_INTERNAL_CLK) | \
					 PIN_MODE_INPUT(PA06_SRVB1) | \
					 PIN_MODE_INPUT(PA07_SRVB2) | \
					 PIN_MODE_INPUT(PA08) | \
					 PIN_MODE_INPUT(PA09_USB_VBUS) | \
					 PIN_MODE_ALTERNATE(PA10_DSHOT_TLM) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_OPENDRAIN(PA00_AUX_A1) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PA05_SPI6_INTERNAL_CLK) | \
					 PIN_OTYPE_OPENDRAIN(PA06_SRVB1) | \
					 PIN_OTYPE_OPENDRAIN(PA07_SRVB2) | \
					 PIN_OTYPE_PUSHPULL(PA08) | \
					 PIN_OTYPE_OPENDRAIN(PA09_USB_VBUS) | \
					 PIN_OTYPE_PUSHPULL(PA10_DSHOT_TLM) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PA00_AUX_A1) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PA05_SPI6_INTERNAL_CLK) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA06_SRVB1) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA07_SRVB2) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA08) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA09_USB_VBUS) | \
					 PIN_OSPEED_SPEED_HIGH(PA10_DSHOT_TLM) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_PULLDOWN(PA00_AUX_A1) | \
					 ...
					 PIN_PUPDR_FLOATING(PA05_SPI6_INTERNAL_CLK) | \
					 PIN_PUPDR_PULLDOWN(PA06_SRVB1) | \
					 PIN_PUPDR_PULLDOWN(PA07_SRVB2) | \
					 PIN_PUPDR_PULLDOWN(PA08) | \
					 PIN_PUPDR_PULLDOWN(PA09_USB_VBUS) | \
					 PIN_PUPDR_FLOATING(PA10_DSHOT_TLM) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(PA00_AUX_A1) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PA05_SPI6_INTERNAL_CLK) | \
					 PIN_ODR_LEVEL_HIGH(PA06_SRVB1) | \
					 PIN_ODR_LEVEL_HIGH(PA07_SRVB2) | \
					 PIN_ODR_LEVEL_LOW(PA08) | \
					 PIN_ODR_LEVEL_LOW(PA09_USB_VBUS) | \
					 PIN_ODR_LEVEL_HIGH(PA10_DSHOT_TLM) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_AUX_A1, 0) | \
					 ...
					 PIN_AFIO_AF(PA04, 0) | \
					 PIN_AFIO_AF(PA05_SPI6_INTERNAL_CLK, 8) | \
					 PIN_AFIO_AF(PA06_SRVB1, 0) | \
					 PIN_AFIO_AF(PA07_SRVB2, 0))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08, 0) | \
					 PIN_AFIO_AF(PA09_USB_VBUS, 0) | \
					 PIN_AFIO_AF(PA10_DSHOT_TLM, 7) | \
...
#define VAL_GPIOB_MODER                 (PIN_MODE_INPUT(PB00_SRVB3) | \
					 PIN_MODE_INPUT(PB01_SRVB4) | \
					 PIN_MODE_INPUT(PB02) | \
					 PIN_MODE_ALTERNATE(PB03_UART7_RX) | \
					 PIN_MODE_ALTERNATE(PB04_SPI6_INTERNAL_MISO) | \
					 PIN_MODE_ALTERNATE(PB05_SPI6_INTERNAL_MOSI) | \
					 PIN_MODE_ALTERNATE(PB06_AUX_B1) | \
					 PIN_MODE_ALTERNATE(PB07_AUX_B2) | \
					 PIN_MODE_ALTERNATE(PB08_AUX_B3) | \
					 PIN_MODE_ALTERNATE(PB09_AUX_B4) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_OPENDRAIN(PB00_SRVB3) | \
					 PIN_OTYPE_OPENDRAIN(PB01_SRVB4) | \
					 PIN_OTYPE_PUSHPULL(PB02) | \
					 PIN_OTYPE_PUSHPULL(PB03_UART7_RX) | \
					 PIN_OTYPE_PUSHPULL(PB04_SPI6_INTERNAL_MISO) | \
					 PIN_OTYPE_PUSHPULL(PB05_SPI6_INTERNAL_MOSI) | \
					 PIN_OTYPE_PUSHPULL(PB06_AUX_B1) | \
					 PIN_OTYPE_PUSHPULL(PB07_AUX_B2) | \
					 PIN_OTYPE_PUSHPULL(PB08_AUX_B3) | \
					 PIN_OTYPE_PUSHPULL(PB09_AUX_B4) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00_SRVB3) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB01_SRVB4) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB02) | \
					 PIN_OSPEED_SPEED_HIGH(PB03_UART7_RX) | \
					 PIN_OSPEED_SPEED_HIGH(PB04_SPI6_INTERNAL_MISO) | \
					 PIN_OSPEED_SPEED_HIGH(PB05_SPI6_INTERNAL_MOSI) | \
					 PIN_OSPEED_SPEED_HIGH(PB06_AUX_B1) | \
					 PIN_OSPEED_SPEED_HIGH(PB07_AUX_B2) | \
					 PIN_OSPEED_SPEED_HIGH(PB08_AUX_B3) | \
					 PIN_OSPEED_SPEED_HIGH(PB09_AUX_B4) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_PULLDOWN(PB00_SRVB3) | \
					 PIN_PUPDR_PULLDOWN(PB01_SRVB4) | \
					 PIN_PUPDR_PULLDOWN(PB02) | \
					 PIN_PUPDR_FLOATING(PB03_UART7_RX) | \
					 PIN_PUPDR_FLOATING(PB04_SPI6_INTERNAL_MISO) | \
					 PIN_PUPDR_FLOATING(PB05_SPI6_INTERNAL_MOSI) | \
					 PIN_PUPDR_FLOATING(PB06_AUX_B1) | \
					 PIN_PUPDR_FLOATING(PB07_AUX_B2) | \
					 PIN_PUPDR_FLOATING(PB08_AUX_B3) | \
					 PIN_PUPDR_FLOATING(PB09_AUX_B4) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_HIGH(PB00_SRVB3) | \
					 PIN_ODR_LEVEL_HIGH(PB01_SRVB4) | \
					 PIN_ODR_LEVEL_LOW(PB02) | \
					 PIN_ODR_LEVEL_HIGH(PB03_UART7_RX) | \
					 PIN_ODR_LEVEL_HIGH(PB04_SPI6_INTERNAL_MISO) | \
					 PIN_ODR_LEVEL_HIGH(PB05_SPI6_INTERNAL_MOSI) | \
					 PIN_ODR_LEVEL_LOW(PB06_AUX_B1) | \
					 PIN_ODR_LEVEL_LOW(PB07_AUX_B2) | \
					 PIN_ODR_LEVEL_LOW(PB08_AUX_B3) | \
					 PIN_ODR_LEVEL_LOW(PB09_AUX_B4) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00_SRVB3, 0) | \
					 PIN_AFIO_AF(PB01_SRVB4, 0) | \
					 PIN_AFIO_AF(PB02, 0) | \
					 PIN_AFIO_AF(PB03_UART7_RX, 11) | \
					 PIN_AFIO_AF(PB04_SPI6_INTERNAL_MISO, 8) | \
					 PIN_AFIO_AF(PB05_SPI6_INTERNAL_MOSI, 8) | \
					 PIN_AFIO_AF(PB06_AUX_B1, 2) | \
					 PIN_AFIO_AF(PB07_AUX_B2, 2))

#define VAL_GPIOB_AFRH			(PIN_AFIO_AF(PB08_AUX_B3, 2) | \
					 PIN_AFIO_AF(PB09_AUX_B4, 2) | \
...
#define VAL_GPIOC_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PC00_VBAT_MEAS) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PC07_LED1) | \
...
#define VAL_GPIOD_MODER                 (PIN_MODE_ALTERNATE(PD00_CAN_RX) | \
					 ...
					 PIN_MODE_INPUT(PD11) | \
					 PIN_MODE_ALTERNATE(PD12_I2C4_SCL_INTERNAL) | \
					 PIN_MODE_ALTERNATE(PD13_I2C4_SDA_INTERNAL) | \
					 PIN_MODE_INPUT(PD14) | \
					 PIN_MODE_OUTPUT(PD15_LED3))
...
#define VAL_GPIOD_OTYPER                (PIN_OTYPE_PUSHPULL(PD00_CAN_RX) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PD12_I2C4_SCL_INTERNAL) | \
					 PIN_OTYPE_OPENDRAIN(PD13_I2C4_SDA_INTERNAL) | \
					 PIN_OTYPE_PUSHPULL(PD14) | \
					 PIN_OTYPE_PUSHPULL(PD15_LED3))
...
#define VAL_GPIOD_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PD00_CAN_RX) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PD04_LED2) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PD12_I2C4_SCL_INTERNAL) | \
					 PIN_OSPEED_SPEED_HIGH(PD13_I2C4_SDA_INTERNAL) | \
					 PIN_OSPEED_SPEED_VERYLOW(PD14) | \
					 PIN_OSPEED_SPEED_VERYLOW(PD15_LED3))
...
#define VAL_GPIOD_PUPDR                 (PIN_PUPDR_FLOATING(PD00_CAN_RX) | \
					 ...
					 PIN_PUPDR_PULLUP(PD12_I2C4_SCL_INTERNAL) | \
					 PIN_PUPDR_PULLUP(PD13_I2C4_SDA_INTERNAL) | \
					 PIN_PUPDR_PULLDOWN(PD14) | \
					 PIN_PUPDR_FLOATING(PD15_LED3))
...
#define VAL_GPIOD_ODR                   (PIN_ODR_LEVEL_HIGH(PD00_CAN_RX) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PD12_I2C4_SCL_INTERNAL) | \
					 PIN_ODR_LEVEL_HIGH(PD13_I2C4_SDA_INTERNAL) | \
					 PIN_ODR_LEVEL_LOW(PD14) | \
					 PIN_ODR_LEVEL_LOW(PD15_LED3))
...
#define VAL_GPIOD_AFRH			(PIN_AFIO_AF(PD08_UART3_TX, 7) | \
					 ...
					 PIN_AFIO_AF(PD11, 0) | \
					 PIN_AFIO_AF(PD12_I2C4_SCL_INTERNAL, 4) | \
					 PIN_AFIO_AF(PD13_I2C4_SDA_INTERNAL, 4) | \
					 PIN_AFIO_AF(PD14, 0) | \
					 PIN_AFIO_AF(PD15_LED3, 0))
...
#define AF_PA05_SPI6_INTERNAL_CLK        8U
#define AF_LINE_SPI6_INTERNAL_CLK        8U
#define AF_PA10_DSHOT_TLM                7U
...
#define AF_PB04_SPI6_INTERNAL_MISO       8U
#define AF_LINE_SPI6_INTERNAL_MISO       8U
#define AF_PB05_SPI6_INTERNAL_MOSI       8U
#define AF_LINE_SPI6_INTERNAL_MOSI       8U
#define AF_PB06_AUX_B1                   2U
#define AF_LINE_AUX_B1                   2U
#define AF_PB07_AUX_B2                   2U
#define AF_LINE_AUX_B2                   2U
#define AF_PB08_AUX_B3                   2U
#define AF_LINE_AUX_B3                   2U
#define AF_PB09_AUX_B4                   2U
...
#define AF_PD12_I2C4_SCL_INTERNAL        4U
#define AF_LINE_I2C4_SCL_INTERNAL        4U
#define AF_PD13_I2C4_SDA_INTERNAL        4U
