...
#define	PA05                           5U
#define	PA06_DSHOT3_CH1_OUT            6U
#define	PA07_DSHOT3_CH2_OUT            7U
#define	PA08_DSHOT_SPY                 8U
#define	PA09                           9U
#define	PA10                           10U
#define	PA11                           11U
#define	PA12                           12U
...
#define	PA15_DSHOT2_CH1_OUT            15U

#define	PB00_DSHOT3_CH3_OUT            0U
#define	PB01_DSHOT3_CH4_OUT            1U
#define	PB02                           2U
#define	PB03_DSHOT2_CH2_OUT            3U
#define	PB04                           4U
#define	PB05                           5U
...
#define	PB08                           8U
#define	PB09                           9U
#define	PB10_DSHOT2_CH3_OUT            10U
#define	PB11_DSHOT2_CH4_OUT            11U
#define	PB12                           12U
#define	PB13                           13U
#define	PB14                           14U
#define	PB15                           15U
...
#define	PD10                           10U
#define	PD11                           11U
#define	PD12_DSHOT4_CH1_OUT            12U
#define	PD13_DSHOT4_CH2_OUT            13U
#define	PD14_DSHOT4_CH3_OUT            14U
#define	PD15_DSHOT4_CH4_OUT            15U
...
#define	LINE_A08_DSHOT_SPY             PAL_LINE(GPIOA, 8U)
#define	LINE_A13_SWDIO                 PAL_LINE(GPIOA, 13U)
#define	LINE_A14_SWCLK                 PAL_LINE(GPIOA, 14U)
#define	LINE_A15_DSHOT2_CH1_OUT        PAL_LINE(GPIOA, 15U)

#define	LINE_B00_DSHOT3_CH3_OUT        PAL_LINE(GPIOB, 0U)
#define	LINE_B01_DSHOT3_CH4_OUT        PAL_LINE(GPIOB, 1U)
#define	LINE_B03_DSHOT2_CH2_OUT        PAL_LINE(GPIOB, 3U)
#define	LINE_B06_SHELL_TX              PAL_LINE(GPIOB, 6U)
#define	LINE_B07_SHELL_RX              PAL_LINE(GPIOB, 7U)
#define	LINE_B10_DSHOT2_CH3_OUT        PAL_LINE(GPIOB, 10U)
#define	LINE_B11_DSHOT2_CH4_OUT        PAL_LINE(GPIOB, 11U)
...
#define	LINE_D12_DSHOT4_CH1_OUT        PAL_LINE(GPIOD, 12U)
#define	LINE_D13_DSHOT4_CH2_OUT        PAL_LINE(GPIOD, 13U)
#define	LINE_D14_DSHOT4_CH3_OUT        PAL_LINE(GPIOD, 14U)
#define	LINE_D15_DSHOT4_CH4_OUT        PAL_LINE(GPIOD, 15U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_INPUT(PA00) | \
					 ...
					 PIN_MODE_INPUT(PA05) | \
					 PIN_MODE_ALTERNATE(PA06_DSHOT3_CH1_OUT) | \
					 PIN_MODE_ALTERNATE(PA07_DSHOT3_CH2_OUT) | \
					 PIN_MODE_ALTERNATE(PA08_DSHOT_SPY) | \
					 PIN_MODE_INPUT(PA09) | \
					 PIN_MODE_INPUT(PA10) | \
					 PIN_MODE_INPUT(PA11) | \
					 PIN_MODE_INPUT(PA12) | \
					 ...
					 PIN_MODE_ALTERNATE(PA15_DSHOT2_CH1_OUT))
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PA06_DSHOT3_CH1_OUT) | \
					 PIN_OTYPE_PUSHPULL(PA07_DSHOT3_CH2_OUT) | \
					 PIN_OTYPE_PUSHPULL(PA08_DSHOT_SPY) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PA15_DSHOT2_CH1_OUT))
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PA00) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PA06_DSHOT3_CH1_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PA07_DSHOT3_CH2_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PA08_DSHOT_SPY) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PA15_DSHOT2_CH1_OUT))
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_PULLDOWN(PA00) | \
					 ...
					 PIN_PUPDR_FLOATING(PA06_DSHOT3_CH1_OUT) | \
					 PIN_PUPDR_FLOATING(PA07_DSHOT3_CH2_OUT) | \
					 PIN_PUPDR_FLOATING(PA08_DSHOT_SPY) | \
					 ...
					 PIN_PUPDR_FLOATING(PA15_DSHOT2_CH1_OUT))
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_LOW(PA00) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PA06_DSHOT3_CH1_OUT) | \
					 PIN_ODR_LEVEL_LOW(PA07_DSHOT3_CH2_OUT) | \
					 PIN_ODR_LEVEL_HIGH(PA08_DSHOT_SPY) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PA15_DSHOT2_CH1_OUT))
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00, 0) | \
					 ...
					 PIN_AFIO_AF(PA05, 0) | \
					 PIN_AFIO_AF(PA06_DSHOT3_CH1_OUT, 2) | \
					 PIN_AFIO_AF(PA07_DSHOT3_CH2_OUT, 2))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_DSHOT_SPY, 1) | \
					 PIN_AFIO_AF(PA09, 0) | \
					 PIN_AFIO_AF(PA10, 0) | \
					 PIN_AFIO_AF(PA11, 0) | \
					 PIN_AFIO_AF(PA12, 0) | \
					 ...
					 PIN_AFIO_AF(PA15_DSHOT2_CH1_OUT, 1))

#define VAL_GPIOB_MODER                 (PIN_MODE_ALTERNATE(PB00_DSHOT3_CH3_OUT) | \
					 PIN_MODE_ALTERNATE(PB01_DSHOT3_CH4_OUT) | \
					 PIN_MODE_INPUT(PB02) | \
					 PIN_MODE_ALTERNATE(PB03_DSHOT2_CH2_OUT) | \
					 PIN_MODE_INPUT(PB04) | \
					 PIN_MODE_INPUT(PB05) | \
					 ...
					 PIN_MODE_INPUT(PB08) | \
					 PIN_MODE_INPUT(PB09) | \
					 PIN_MODE_ALTERNATE(PB10_DSHOT2_CH3_OUT) | \
					 PIN_MODE_ALTERNATE(PB11_DSHOT2_CH4_OUT) | \
					 PIN_MODE_INPUT(PB12) | \
					 PIN_MODE_INPUT(PB13) | \
					 PIN_MODE_INPUT(PB14) | \
					 PIN_MODE_INPUT(PB15))

#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00_DSHOT3_CH3_OUT) | \
					 PIN_OTYPE_PUSHPULL(PB01_DSHOT3_CH4_OUT) | \
					 PIN_OTYPE_PUSHPULL(PB02) | \
					 PIN_OTYPE_PUSHPULL(PB03_DSHOT2_CH2_OUT) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PB10_DSHOT2_CH3_OUT) | \
					 PIN_OTYPE_PUSHPULL(PB11_DSHOT2_CH4_OUT) | \
					 PIN_OTYPE_PUSHPULL(PB12) | \
					 PIN_OTYPE_PUSHPULL(PB13) | \
					 PIN_OTYPE_PUSHPULL(PB14) | \
					 PIN_OTYPE_PUSHPULL(PB15))

#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PB00_DSHOT3_CH3_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PB01_DSHOT3_CH4_OUT) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB02) | \
					 PIN_OSPEED_SPEED_HIGH(PB03_DSHOT2_CH2_OUT) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PB10_DSHOT2_CH3_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PB11_DSHOT2_CH4_OUT) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB12) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB13) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB14) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB15))

#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(PB00_DSHOT3_CH3_OUT) | \
					 PIN_PUPDR_FLOATING(PB01_DSHOT3_CH4_OUT) | \
					 PIN_PUPDR_PULLDOWN(PB02) | \
					 PIN_PUPDR_FLOATING(PB03_DSHOT2_CH2_OUT) | \
					 ...
					 PIN_PUPDR_FLOATING(PB10_DSHOT2_CH3_OUT) | \
					 PIN_PUPDR_FLOATING(PB11_DSHOT2_CH4_OUT) | \
					 PIN_PUPDR_PULLDOWN(PB12) | \
					 PIN_PUPDR_PULLDOWN(PB13) | \
					 PIN_PUPDR_PULLDOWN(PB14) | \
					 PIN_PUPDR_PULLDOWN(PB15))

#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(PB00_DSHOT3_CH3_OUT) | \
					 PIN_ODR_LEVEL_LOW(PB01_DSHOT3_CH4_OUT) | \
					 PIN_ODR_LEVEL_LOW(PB02) | \
					 PIN_ODR_LEVEL_LOW(PB03_DSHOT2_CH2_OUT) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PB10_DSHOT2_CH3_OUT) | \
					 PIN_ODR_LEVEL_LOW(PB11_DSHOT2_CH4_OUT) | \
					 PIN_ODR_LEVEL_LOW(PB12) | \
					 PIN_ODR_LEVEL_LOW(PB13) | \
					 PIN_ODR_LEVEL_LOW(PB14) | \
					 PIN_ODR_LEVEL_LOW(PB15))

#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00_DSHOT3_CH3_OUT, 2) | \
					 PIN_AFIO_AF(PB01_DSHOT3_CH4_OUT, 2) | \
					 PIN_AFIO_AF(PB02, 0) | \
					 PIN_AFIO_AF(PB03_DSHOT2_CH2_OUT, 1) | \
					 PIN_AFIO_AF(PB04, 0) | \
					 PIN_AFIO_AF(PB05, 0) | \
...
#define VAL_GPIOB_AFRH			(PIN_AFIO_AF(PB08, 0) | \
					 PIN_AFIO_AF(PB09, 0) | \
					 PIN_AFIO_AF(PB10_DSHOT2_CH3_OUT, 1) | \
					 PIN_AFIO_AF(PB11_DSHOT2_CH4_OUT, 1) | \
					 PIN_AFIO_AF(PB12, 0) | \
					 PIN_AFIO_AF(PB13, 0) | \
					 PIN_AFIO_AF(PB14, 0) | \
					 PIN_AFIO_AF(PB15, 0))
...
#define VAL_GPIOC_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PC00_LED1) | \
					 PIN_OSPEED_SPEED_VERYLOW(PC01_POTAR) | \
...
#define VAL_GPIOD_MODER                 (PIN_MODE_INPUT(PD00) | \
					 ...
					 PIN_MODE_INPUT(PD10) | \
					 PIN_MODE_INPUT(PD11) | \
					 PIN_MODE_ALTERNATE(PD12_DSHOT4_CH1_OUT) | \
					 PIN_MODE_ALTERNATE(PD13_DSHOT4_CH2_OUT) | \
					 PIN_MODE_ALTERNATE(PD14_DSHOT4_CH3_OUT) | \
					 PIN_MODE_ALTERNATE(PD15_DSHOT4_CH4_OUT))
...
#define VAL_GPIOD_OTYPER                (PIN_OTYPE_PUSHPULL(PD00) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PD12_DSHOT4_CH1_OUT) | \
					 PIN_OTYPE_PUSHPULL(PD13_DSHOT4_CH2_OUT) | \
					 PIN_OTYPE_PUSHPULL(PD14_DSHOT4_CH3_OUT) | \
					 PIN_OTYPE_PUSHPULL(PD15_DSHOT4_CH4_OUT))
...
#define VAL_GPIOD_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PD00) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PD12_DSHOT4_CH1_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PD13_DSHOT4_CH2_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PD14_DSHOT4_CH3_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PD15_DSHOT4_CH4_OUT))
...
#define VAL_GPIOD_PUPDR                 (PIN_PUPDR_PULLDOWN(PD00) | \
					 ...
					 PIN_PUPDR_FLOATING(PD12_DSHOT4_CH1_OUT) | \
					 PIN_PUPDR_FLOATING(PD13_DSHOT4_CH2_OUT) | \
					 PIN_PUPDR_FLOATING(PD14_DSHOT4_CH3_OUT) | \
					 PIN_PUPDR_FLOATING(PD15_DSHOT4_CH4_OUT))
...
#define VAL_GPIOD_ODR                   (PIN_ODR_LEVEL_LOW(PD00) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PD12_DSHOT4_CH1_OUT) | \
					 PIN_ODR_LEVEL_LOW(PD13_DSHOT4_CH2_OUT) | \
					 PIN_ODR_LEVEL_LOW(PD14_DSHOT4_CH3_OUT) | \
					 PIN_ODR_LEVEL_LOW(PD15_DSHOT4_CH4_OUT))
...
#define VAL_GPIOD_AFRH			(PIN_AFIO_AF(PD08, 0) | \
					 ...
					 PIN_AFIO_AF(PD10, 0) | \
					 PIN_AFIO_AF(PD11, 0) | \
					 PIN_AFIO_AF(PD12_DSHOT4_CH1_OUT, 2) | \
					 PIN_AFIO_AF(PD13_DSHOT4_CH2_OUT, 2) | \
					 PIN_AFIO_AF(PD14_DSHOT4_CH3_OUT, 2) | \
					 PIN_AFIO_AF(PD15_DSHOT4_CH4_OUT, 2))
...
#define AF_LINE_A07_DSHOT3_CH2_OUT       2U
#define AF_PA08_DSHOT_SPY                1U
#define AF_LINE_A08_DSHOT_SPY            1U
#define AF_PA13_SWDIO                    0U
#define AF_LINE_A13_SWDIO                0U
#define AF_PA14_SWCLK                    0U
#define AF_LINE_A14_SWCLK                0U
#define AF_PA15_DSHOT2_CH1_OUT           1U
#define AF_LINE_A15_DSHOT2_CH1_OUT       1U
#define AF_PB00_DSHOT3_CH3_OUT           2U
#define AF_LINE_B00_DSHOT3_CH3_OUT       2U
#define AF_PB01_DSHOT3_CH4_OUT           2U
#define AF_LINE_B01_DSHOT3_CH4_OUT       2U
#define AF_PB03_DSHOT2_CH2_OUT           1U
#define AF_LINE_B03_DSHOT2_CH2_OUT       1U
#define AF_PB06_SHELL_TX                 7U
#define AF_LINE_B06_SHELL_TX             7U
#define AF_PB07_SHELL_RX                 7U
#define AF_LINE_B07_SHELL_RX             7U
#define AF_PB10_DSHOT2_CH3_OUT           1U
...
#define AF_LINE_D13_DSHOT4_CH2_OUT       2U
#define AF_PD14_DSHOT4_CH3_OUT           2U
#define AF_LINE_D14_DSHOT4_CH3_OUT       2U
#define AF_PD15_DSHOT4_CH4_OUT           2U
#define AF_LINE_D15_DSHOT4_CH4_OUT       2U


#define DSHOT3_CH1_OUT_TIM	 3
#define DSHOT3_CH1_OUT_TIM_FN	 CH
#define DSHOT3_CH1_OUT_TIM_CH	 1
#define DSHOT3_CH1_OUT_TIM_AF	 2
#define DSHOT3_CH2_OUT_TIM	 3
#define DSHOT3_CH2_OUT_TIM_FN	 CH
#define DSHOT3_CH2_OUT_TIM_CH	 2
#define DSHOT3_CH2_OUT_TIM_AF	 2
#define DSHOT_SPY_TIM	 1
#define DSHOT_SPY_TIM_FN	 CH
#define DSHOT_SPY_TIM_CH	 1
#define DSHOT_SPY_TIM_AF	 1
#define DSHOT3_CH3_OUT_TIM	 3
#define DSHOT3_CH3_OUT_TIM_FN	 CH
#define DSHOT3_CH3_OUT_TIM_CH	 3
#define DSHOT3_CH3_OUT_TIM_AF	 2
#define DSHOT3_CH4_OUT_TIM	 3
#define DSHOT3_CH4_OUT_TIM_FN	 CH
#define DSHOT3_CH4_OUT_TIM_CH	 4
#define DSHOT3_CH4_OUT_TIM_AF	 2
#define DSHOT2_CH1_OUT_TIM	 2
#define DSHOT2_CH1_OUT_TIM_FN	 CH
#define DSHOT2_CH1_OUT_TIM_CH	 1
#define DSHOT2_CH1_OUT_TIM_AF	 1
#define DSHOT2_CH2_OUT_TIM	 2
#define DSHOT2_CH2_OUT_TIM_FN	 CH
#define DSHOT2_CH2_OUT_TIM_CH	 2
#define DSHOT2_CH2_OUT_TIM_AF	 1
#define DSHOT2_CH3_OUT_TIM	 2
#define DSHOT2_CH3_OUT_TIM_FN	 CH
#define DSHOT2_CH3_OUT_TIM_CH	 3
#define DSHOT2_CH3_OUT_TIM_AF	 1
#define DSHOT2_CH4_OUT_TIM	 2
#define DSHOT2_CH4_OUT_TIM_FN	 CH
#define DSHOT2_CH4_OUT_TIM_CH	 4
#define DSHOT2_CH4_OUT_TIM_AF	 1
#define DSHOT4_CH1_OUT_TIM	 4
#define DSHOT4_CH1_OUT_TIM_FN	 CH
#define DSHOT4_CH1_OUT_TIM_CH	 1
#define DSHOT4_CH1_OUT_TIM_AF	 2
#define DSHOT4_CH2_OUT_TIM	 4
#define DSHOT4_CH2_OUT_TIM_FN	 CH
#define DSHOT4_CH2_OUT_TIM_CH	 2
#define DSHOT4_CH2_OUT_TIM_AF	 2
#define DSHOT4_CH3_OUT_TIM	 4
#define DSHOT4_CH3_OUT_TIM_FN	 CH
#define DSHOT4_CH3_OUT_TIM_CH	 3
#define DSHOT4_CH3_OUT_TIM_AF	 2
#define DSHOT4_CH4_OUT_TIM	 4
#define DSHOT4_CH4_OUT_TIM_FN	 CH
#define DSHOT4_CH4_OUT_TIM_CH	 4
#define DSHOT4_CH4_OUT_TIM_AF	 2
