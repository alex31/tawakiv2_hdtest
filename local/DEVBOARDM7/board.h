 ...
 * IO pins assignments.
 */
#define	PA00_DSHOT1_CH1_OUT            0U
#define	PA01_DSHOT1_CH2_OUT            1U
#define	PA02_DSHOT1_CH3_OUT            2U
#define	PA03_DSHOT1_CH4_OUT            3U
#define	PA04_DEBUG_LOGIC               4U
#define	PA05                           5U
#define	PA06                           6U
#define	PA07                           7U
#define	PA08_DSHOT2_CH1_OUT            8U
#define	PA09_DSHOT2_CH2_OUT            9U
#define	PA10_DSHOT2_CH3_OUT            10U
#define	PA11_DSHOT2_CH4_OUT            11U
#define	PA12                           12U
 ...
 */
#define	LINE_A00_DSHOT1_CH1_OUT        PAL_LINE(GPIOA, 0U)
#define	LINE_A01_DSHOT1_CH2_OUT        PAL_LINE(GPIOA, 1U)
#define	LINE_A02_DSHOT1_CH3_OUT        PAL_LINE(GPIOA, 2U)
#define	LINE_A03_DSHOT1_CH4_OUT        PAL_LINE(GPIOA, 3U)
#define	LINE_A04_DEBUG_LOGIC           PAL_LINE(GPIOA, 4U)
#define	LINE_A08_DSHOT2_CH1_OUT        PAL_LINE(GPIOA, 8U)
#define	LINE_A09_DSHOT2_CH2_OUT        PAL_LINE(GPIOA, 9U)
#define	LINE_A10_DSHOT2_CH3_OUT        PAL_LINE(GPIOA, 10U)
#define	LINE_A11_DSHOT2_CH4_OUT        PAL_LINE(GPIOA, 11U)
...
#define	LINE_D06_DSHOT_TLM             PAL_LINE(GPIOD, 6U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(PA00_DSHOT1_CH1_OUT) | \
					 PIN_MODE_ALTERNATE(PA01_DSHOT1_CH2_OUT) | \
					 PIN_MODE_ALTERNATE(PA02_DSHOT1_CH3_OUT) | \
					 PIN_MODE_ALTERNATE(PA03_DSHOT1_CH4_OUT) | \
					 PIN_MODE_OUTPUT(PA04_DEBUG_LOGIC) | \
					 PIN_MODE_INPUT(PA05) | \
					 PIN_MODE_INPUT(PA06) | \
					 PIN_MODE_INPUT(PA07) | \
					 PIN_MODE_ALTERNATE(PA08_DSHOT2_CH1_OUT) | \
					 PIN_MODE_ALTERNATE(PA09_DSHOT2_CH2_OUT) | \
					 PIN_MODE_ALTERNATE(PA10_DSHOT2_CH3_OUT) | \
					 PIN_MODE_ALTERNATE(PA11_DSHOT2_CH4_OUT) | \
					 PIN_MODE_INPUT(PA12) | \
					 PIN_MODE_ALTERNATE(PA13_SWDIO) | \
					 PIN_MODE_ALTERNATE(PA14_SWCLK) | \
					 PIN_MODE_INPUT(PA15))

#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00_DSHOT1_CH1_OUT) | \
					 PIN_OTYPE_PUSHPULL(PA01_DSHOT1_CH2_OUT) | \
					 PIN_OTYPE_PUSHPULL(PA02_DSHOT1_CH3_OUT) | \
					 PIN_OTYPE_PUSHPULL(PA03_DSHOT1_CH4_OUT) | \
					 PIN_OTYPE_PUSHPULL(PA04_DEBUG_LOGIC) | \
					 PIN_OTYPE_PUSHPULL(PA05) | \
					 PIN_OTYPE_PUSHPULL(PA06) | \
					 PIN_OTYPE_PUSHPULL(PA07) | \
					 PIN_OTYPE_PUSHPULL(PA08_DSHOT2_CH1_OUT) | \
					 PIN_OTYPE_PUSHPULL(PA09_DSHOT2_CH2_OUT) | \
					 PIN_OTYPE_PUSHPULL(PA10_DSHOT2_CH3_OUT) | \
					 PIN_OTYPE_PUSHPULL(PA11_DSHOT2_CH4_OUT) | \
					 PIN_OTYPE_PUSHPULL(PA12) | \
					 PIN_OTYPE_PUSHPULL(PA13_SWDIO) | \
					 PIN_OTYPE_PUSHPULL(PA14_SWCLK) | \
					 PIN_OTYPE_PUSHPULL(PA15))

#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PA00_DSHOT1_CH1_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PA01_DSHOT1_CH2_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PA02_DSHOT1_CH3_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PA03_DSHOT1_CH4_OUT) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PA08_DSHOT2_CH1_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PA09_DSHOT2_CH2_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PA10_DSHOT2_CH3_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PA11_DSHOT2_CH4_OUT) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(PA00_DSHOT1_CH1_OUT) | \
					 PIN_PUPDR_FLOATING(PA01_DSHOT1_CH2_OUT) | \
					 PIN_PUPDR_FLOATING(PA02_DSHOT1_CH3_OUT) | \
					 PIN_PUPDR_FLOATING(PA03_DSHOT1_CH4_OUT) | \
					 PIN_PUPDR_FLOATING(PA04_DEBUG_LOGIC) | \
					 PIN_PUPDR_PULLDOWN(PA05) | \
					 PIN_PUPDR_PULLDOWN(PA06) | \
					 PIN_PUPDR_PULLDOWN(PA07) | \
					 PIN_PUPDR_FLOATING(PA08_DSHOT2_CH1_OUT) | \
					 PIN_PUPDR_FLOATING(PA09_DSHOT2_CH2_OUT) | \
					 PIN_PUPDR_FLOATING(PA10_DSHOT2_CH3_OUT) | \
					 PIN_PUPDR_FLOATING(PA11_DSHOT2_CH4_OUT) | \
					 PIN_PUPDR_PULLDOWN(PA12) | \
					 PIN_PUPDR_FLOATING(PA13_SWDIO) | \
					 PIN_PUPDR_FLOATING(PA14_SWCLK) | \
					 PIN_PUPDR_PULLDOWN(PA15))

#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_LOW(PA00_DSHOT1_CH1_OUT) | \
					 PIN_ODR_LEVEL_LOW(PA01_DSHOT1_CH2_OUT) | \
					 PIN_ODR_LEVEL_LOW(PA02_DSHOT1_CH3_OUT) | \
					 PIN_ODR_LEVEL_LOW(PA03_DSHOT1_CH4_OUT) | \
					 PIN_ODR_LEVEL_LOW(PA04_DEBUG_LOGIC) | \
					 PIN_ODR_LEVEL_LOW(PA05) | \
					 PIN_ODR_LEVEL_LOW(PA06) | \
					 PIN_ODR_LEVEL_LOW(PA07) | \
					 PIN_ODR_LEVEL_LOW(PA08_DSHOT2_CH1_OUT) | \
					 PIN_ODR_LEVEL_LOW(PA09_DSHOT2_CH2_OUT) | \
					 PIN_ODR_LEVEL_LOW(PA10_DSHOT2_CH3_OUT) | \
					 PIN_ODR_LEVEL_LOW(PA11_DSHOT2_CH4_OUT) | \
					 PIN_ODR_LEVEL_LOW(PA12) | \
					 PIN_ODR_LEVEL_HIGH(PA13_SWDIO) | \
					 PIN_ODR_LEVEL_HIGH(PA14_SWCLK) | \
					 PIN_ODR_LEVEL_LOW(PA15))

#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_DSHOT1_CH1_OUT, 1) | \
					 PIN_AFIO_AF(PA01_DSHOT1_CH2_OUT, 1) | \
					 PIN_AFIO_AF(PA02_DSHOT1_CH3_OUT, 1) | \
					 PIN_AFIO_AF(PA03_DSHOT1_CH4_OUT, 1) | \
					 PIN_AFIO_AF(PA04_DEBUG_LOGIC, 0) | \
					 PIN_AFIO_AF(PA05, 0) | \
					 PIN_AFIO_AF(PA06, 0) | \
					 PIN_AFIO_AF(PA07, 0))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_DSHOT2_CH1_OUT, 1) | \
					 PIN_AFIO_AF(PA09_DSHOT2_CH2_OUT, 1) | \
					 PIN_AFIO_AF(PA10_DSHOT2_CH3_OUT, 1) | \
					 PIN_AFIO_AF(PA11_DSHOT2_CH4_OUT, 1) | \
					 PIN_AFIO_AF(PA12, 0) | \
...
#define VAL_GPIOD_MODER                 (PIN_MODE_INPUT(PD00) | \
					 ...
					 PIN_MODE_INPUT(PD04) | \
					 PIN_MODE_INPUT(PD05) | \
					 PIN_MODE_ALTERNATE(PD06_DSHOT_TLM) | \
					 PIN_MODE_INPUT(PD07) | \
					 PIN_MODE_INPUT(PD08) | \
					 PIN_MODE_INPUT(PD09) | \
					 PIN_MODE_INPUT(PD10) | \
...
#define VAL_GPIOD_OTYPER                (PIN_OTYPE_PUSHPULL(PD00) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PD06_DSHOT_TLM) | \
...
#define VAL_GPIOD_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PD00) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PD06_DSHOT_TLM) | \
...
#define VAL_GPIOD_PUPDR                 (PIN_PUPDR_PULLDOWN(PD00) | \
					 ...
					 PIN_PUPDR_FLOATING(PD06_DSHOT_TLM) | \
...
#define VAL_GPIOD_ODR                   (PIN_ODR_LEVEL_LOW(PD00) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PD06_DSHOT_TLM) | \
...
#define AF_PA00_DSHOT1_CH1_OUT           1U
#define AF_LINE_A00_DSHOT1_CH1_OUT       1U
#define AF_PA01_DSHOT1_CH2_OUT           1U
#define AF_LINE_A01_DSHOT1_CH2_OUT       1U
#define AF_PA02_DSHOT1_CH3_OUT           1U
#define AF_LINE_A02_DSHOT1_CH3_OUT       1U
#define AF_PA03_DSHOT1_CH4_OUT           1U
#define AF_LINE_A03_DSHOT1_CH4_OUT       1U
#define AF_PA08_DSHOT2_CH1_OUT           1U
#define AF_LINE_A08_DSHOT2_CH1_OUT       1U
#define AF_PA09_DSHOT2_CH2_OUT           1U
#define AF_LINE_A09_DSHOT2_CH2_OUT       1U
#define AF_PA10_DSHOT2_CH3_OUT           1U
#define AF_LINE_A10_DSHOT2_CH3_OUT       1U
#define AF_PA11_DSHOT2_CH4_OUT           1U
#define AF_LINE_A11_DSHOT2_CH4_OUT       1U
