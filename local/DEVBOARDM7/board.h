...
#define	PA15_DSHOT3_CH1_OUT            15U

#define	PB00                           0U
#define	PB01                           1U
#define	PB02                           2U
#define	PB03_DSHOT3_CH2_OUT            3U
#define	PB04                           4U
#define	PB05                           5U
...
#define	PB08                           8U
#define	PB09                           9U
#define	PB10_DSHOT3_CH3_OUT            10U
#define	PB11_DSHOT3_CH4_OUT            11U
#define	PB12                           12U
#define	PB13                           13U
#define	PB14                           14U
#define	PB15                           15U
...
#define	LINE_A15_DSHOT3_CH1_OUT        PAL_LINE(GPIOA, 15U)

#define	LINE_B03_DSHOT3_CH2_OUT        PAL_LINE(GPIOB, 3U)
#define	LINE_B06_SHELL_TX              PAL_LINE(GPIOB, 6U)
#define	LINE_B07_SHELL_RX              PAL_LINE(GPIOB, 7U)
#define	LINE_B10_DSHOT3_CH3_OUT        PAL_LINE(GPIOB, 10U)
#define	LINE_B11_DSHOT3_CH4_OUT        PAL_LINE(GPIOB, 11U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_INPUT(PA00) | \
					 ...
					 PIN_MODE_ALTERNATE(PA15_DSHOT3_CH1_OUT))
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PA15_DSHOT3_CH1_OUT))
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PA00) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PA15_DSHOT3_CH1_OUT))
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_PULLDOWN(PA00) | \
					 ...
					 PIN_PUPDR_FLOATING(PA15_DSHOT3_CH1_OUT))
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_LOW(PA00) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PA15_DSHOT3_CH1_OUT))
...
#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_DSHOT_SPY, 1) | \
					 ...
					 PIN_AFIO_AF(PA15_DSHOT3_CH1_OUT, 1))

#define VAL_GPIOB_MODER                 (PIN_MODE_INPUT(PB00) | \
					 PIN_MODE_INPUT(PB01) | \
					 PIN_MODE_INPUT(PB02) | \
					 PIN_MODE_ALTERNATE(PB03_DSHOT3_CH2_OUT) | \
					 PIN_MODE_INPUT(PB04) | \
					 PIN_MODE_INPUT(PB05) | \
					 ...
					 PIN_MODE_INPUT(PB08) | \
					 PIN_MODE_INPUT(PB09) | \
					 PIN_MODE_ALTERNATE(PB10_DSHOT3_CH3_OUT) | \
					 PIN_MODE_ALTERNATE(PB11_DSHOT3_CH4_OUT) | \
					 PIN_MODE_INPUT(PB12) | \
					 PIN_MODE_INPUT(PB13) | \
					 PIN_MODE_INPUT(PB14) | \
					 PIN_MODE_INPUT(PB15))
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PB03_DSHOT3_CH2_OUT) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PB10_DSHOT3_CH3_OUT) | \
					 PIN_OTYPE_PUSHPULL(PB11_DSHOT3_CH4_OUT) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PB03_DSHOT3_CH2_OUT) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PB10_DSHOT3_CH3_OUT) | \
					 PIN_OSPEED_SPEED_HIGH(PB11_DSHOT3_CH4_OUT) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_PULLDOWN(PB00) | \
					 ...
					 PIN_PUPDR_FLOATING(PB03_DSHOT3_CH2_OUT) | \
					 ...
					 PIN_PUPDR_FLOATING(PB10_DSHOT3_CH3_OUT) | \
					 PIN_PUPDR_FLOATING(PB11_DSHOT3_CH4_OUT) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(PB00) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PB03_DSHOT3_CH2_OUT) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PB10_DSHOT3_CH3_OUT) | \
					 PIN_ODR_LEVEL_LOW(PB11_DSHOT3_CH4_OUT) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00, 0) | \
					 PIN_AFIO_AF(PB01, 0) | \
					 PIN_AFIO_AF(PB02, 0) | \
					 PIN_AFIO_AF(PB03_DSHOT3_CH2_OUT, 1) | \
					 PIN_AFIO_AF(PB04, 0) | \
					 PIN_AFIO_AF(PB05, 0) | \
...
#define VAL_GPIOB_AFRH			(PIN_AFIO_AF(PB08, 0) | \
					 PIN_AFIO_AF(PB09, 0) | \
					 PIN_AFIO_AF(PB10_DSHOT3_CH3_OUT, 1) | \
					 PIN_AFIO_AF(PB11_DSHOT3_CH4_OUT, 1) | \
					 PIN_AFIO_AF(PB12, 0) | \
					 PIN_AFIO_AF(PB13, 0) | \
					 PIN_AFIO_AF(PB14, 0) | \
					 PIN_AFIO_AF(PB15, 0))
...
#define AF_PA15_DSHOT3_CH1_OUT           1U
#define AF_LINE_A15_DSHOT3_CH1_OUT       1U
#define AF_PB03_DSHOT3_CH2_OUT           1U
#define AF_LINE_B03_DSHOT3_CH2_OUT       1U
#define AF_PB06_SHELL_TX                 7U
#define AF_LINE_B06_SHELL_TX             7U
#define AF_PB07_SHELL_RX                 7U
#define AF_LINE_B07_SHELL_RX             7U
#define AF_PB10_DSHOT3_CH3_OUT           1U
#define AF_LINE_B10_DSHOT3_CH3_OUT       1U
#define AF_PB11_DSHOT3_CH4_OUT           1U
#define AF_LINE_B11_DSHOT3_CH4_OUT       1U
